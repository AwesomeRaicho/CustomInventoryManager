...
namespace ServicesContracts
{
    public interface ICostumeService
    {
        ...
        Task<CostumeResponse> AddCostume(CostumeAddRequest? costumeAddRequest);

        /// <summary>
        /// Gets all costumes in DB
        /// </summary>
        /// <returns>List of CostumeResponse</returns>
        Task<List<CostumeResponse>>  GetAllCostumes();
        ...
        Task<CostumeResponse?> GetCostumeByCostumeID(Guid? costumeID);

        Task<List<CostumeResponse>>  GetAllSoldCostumes();
        ...
        Task<bool>  SoldCostumeByCostumeID(Guid? costumeID);
        ...
        Task<bool>  DeleteCostume(Guid? costumeID);
        ...
        Task<List<CostumeResponse>>  GetFilteredCostumes(string filterBy, string? searchString);
        ...
        /// <returns></returns>
        Task<List<CostumeResponse>>  GetSortedCostumes(List<CostumeResponse> allCostumes, string orderBy, SortOrderOptions sortOrder);

        Task<CostumeResponse>  UpdateCostume(CostumeUpdateRequest? costumeUpdateRequest);
