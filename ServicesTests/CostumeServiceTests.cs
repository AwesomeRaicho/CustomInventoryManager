...
namespace ServicesTests
{
    public class CostumeServiceTests
    {
        ...
        [Fact]
        public async Task GetFilteredCostumes_CorrectFiltering()
        {
            //Arrange
            CostumeAddRequest costume1 = new CostumeAddRequest()
            {
            ...
            List<Costume> repoReturn = new List<Costume>();

            costumeResponses_from_add.Add(costume1.ToCostume().ToCostumeResponse());
            costumeResponses_from_add.Add(costume2.ToCostume().ToCostumeResponse());
            costumeResponses_from_add.Add(costume3.ToCostume().ToCostumeResponse());

            repoReturn.Add(costume1.ToCostume());
            repoReturn.Add(costume2.ToCostume());
            repoReturn.Add(costume3.ToCostume());
            ...
            _costumeRepo.Setup(x => x.GetAll(It.IsAny<int>(), It.IsAny<int>())).ReturnsAsync(repoReturn);

            //Act
            List<CostumeResponse> costumeResponses_from_getFiltered = await _costumeService.GetFilteredCostumes(nameof(Costume.CostumeName), "man");
        ...
        [Fact]
        public async Task DeleteCostume_NullID()
        {
            //Arrange
            Guid? id = null;
            ...
            {
                //Act
                bool response = await _costumeService.DeleteCostume(id);
        ...
        [Fact]
        public async Task DeleteCostume_IDNotInDB()
        {
            //Arrange
        ...
        [Fact]
        public async Task DeleteCostume_DeletedCorrectly()
        {
            //Arrange
            ...
            CostumeResponse costume_response = costume_request.ToCostume().ToCostumeResponse();

            _costumeRepo.Setup(x => x.GetById(It.IsAny<Guid>())).ReturnsAsync(costume_request.ToCostume());

            //Act
            bool response = await _costumeService.DeleteCostume(costume_response.CostumeID);
        ...
        [Fact]
        public async Task GetSortedCostumes_CorrectlySorted()
        {
            //Arrange
            ...
            List<CostumeResponse> costumeResponses_from_add = new List<CostumeResponse>();
            costumeResponses_from_add.Add(costume0.ToCostume().ToCostumeResponse());
            costumeResponses_from_add.Add(costume1.ToCostume().ToCostumeResponse());
            costumeResponses_from_add.Add(costume2.ToCostume().ToCostumeResponse());
            costumeResponses_from_add.Add(costume3.ToCostume().ToCostumeResponse());
            ...
            //Act
            List<CostumeResponse> costumeResponses_from_getSort = await _costumeService.GetSortedCostumes(costumeResponses_from_add, nameof(Costume.CostumeName), SortOrderOptions.ASC);
        ...
        [Fact]
        public async Task UpdateCostume_NullCostume()
        {
            //Arrange
            ...
            {
                //Act
                await _costumeService.UpdateCostume(costume_to_update);
            });
        }


        [Fact]
        public async Task UpdateCostume_ProperUpdate()
        {
            //Arrange
            ...
            CostumeResponse costume_response = costume.ToCostume().ToCostumeResponse();

            CostumeUpdateRequest costume_update = costume_response.GetCostumeUpdateRequest();
            costume_update.CostumeName = "ReverseFlash";

            _costumeRepo.Setup(x => x.GetById(It.IsAny<Guid>())).ReturnsAsync(costume.ToCostume());

            //Act
            await _costumeService.UpdateCostume(costume_update);

            //get costume from DB and verify if the new name is on it
            CostumeResponse? costume_from_get = await _costumeService.GetCostumeByCostumeID(costume_response.CostumeID);
